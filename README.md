...
- **语法高亮**：TypeScript、JavaScript、TSX、JSX、Java、Rust、Go、Python、GDScript、XML、Groovy、Gradle、Kotlin、Kotlin DSL、Properties、Bash、Batch、JSON、JSONC、JSON5、JSONL、TOML、YAML、Markdown、CSS、SCSS、Sass、Less。
